//Using AES256 module npm, slightly modified to meet working requirments
...
var aes256 = {
  ...
  encrypt: function(key, input) {
    ...
    var cipher = crypto.createCipheriv(CIPHER_ALGORITHM, temp, iv);
  ...
  decrypt: function(key, encrypted) {
    ...
    var decipher = crypto.createDecipheriv(CIPHER_ALGORITHM, temp, iv);
