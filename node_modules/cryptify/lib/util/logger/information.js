...
function printPasswordRequirements() {
  ...
  _index.default.log('Pass "--loose" (or "-o") to bypass password requirements.');
}
/**
...
function printCiphers() {
  ...
  _index.default.info("Listing ".concat(_const.SupportedCiphers.length, " supported ciphers..."));

  _index.default.blank();

  _const.SupportedCiphers.forEach(cipher => _index.default.log(cipher));

  _index.default.blank();

  _index.default.info('https://github.com/mikechabot/cryptify#supported-ciphers');
}
